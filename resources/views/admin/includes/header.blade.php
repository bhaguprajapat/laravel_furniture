...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="{{URL::to('/')}}/public/admin/assets/images/favicon-32x32.png" type="image/png" />
	<!--plugins-->
	...
	<link href="{{URL::to('/')}}/public/admin/assets/css/bootstrap-extended.css" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&display=swap" rel="stylesheet">
	<link href="{{URL::to('/')}}/public/admin/assets/css/app.css" rel="stylesheet">
	<link href="{{URL::to('/')}}/public/admin/assets/css/icons.css" rel="stylesheet">
	<!-- Theme Style CSS -->
